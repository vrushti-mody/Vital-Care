...
{
  $search=$_POST['name'];
  $sql="SELECT * FROM products WHERE (LOCATE('$search',product_name)>0 OR  LOCATE('$search',details)>0 OR  LOCATE('$search',category)>0 AND category='PERSONAL CARE') ";
...
$sql = "SELECT * FROM products WHERE category='PERSONAL CARE'";
$result = mysqli_query($mysqli,$sql);

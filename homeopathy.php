...
{
  $search=$_POST['name'];
  $sql="SELECT * FROM products WHERE (LOCATE('$search',product_name)>0 OR  LOCATE('$search',details)>0 OR  LOCATE('$search',category)>0 AND category='HOMEOPATHY') ";
...
$sql = "SELECT * FROM products WHERE category='HOMEOPATHY'";
$result = mysqli_query($mysqli,$sql);

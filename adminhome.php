...
<div id="hero-image">
    <div class="wrapper">
        <h2>Welcome <?php echo $_SESSION['username1']?>!<br/>
        <strong>To the admin site of Vital care.</strong></h2>
        <a href="adminlogin.php" class="button-1">Log Out</a>
        <br>
        <br>
         <a href="orders.php" class="button-1">Track Orders</a>
    </div>
</div>
    ...
    <div class="wrapper">
        <article style="background-image: url('admin.jpg');">
            <div class="overlay">
                ...
                <a href="createblog.php" class="more-link">Add Blog</a>
            </div>
        </article>
        ...
        <article style="background-image: url('admin.jpg');">
            <div class="overlay">
                ...
                <a href="addproduct.php" class="more-link">Add Product</a>

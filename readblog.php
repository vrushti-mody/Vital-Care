...
<li class="nav-item">
<a href="viewblogs.php" class="nav-link active">WELLNESS ADVICE</a>
</li>
<li class="nav-item">
...
<i class="fa fa-user" aria-hidden="true"></i>
  ...
  <!-- Page Header -->
  <header class="masthead" style="background-image: url('blog_images/<?php echo $id; ?>.jpg')">
      ...
      <div class="row">
        <div class="col-lg-8 col-md-10 mx-auto">
          <div class="post-heading">
            ...
            <span class="meta">Article by: &nbsp<?php echo $author?>
            </span>
          </div>
        </div>
      </div>
